...
{
    private static readonly ConcurrentQueue<Action> deferredActionQueue = new();
    ...
    private static readonly double CheckIntervalSeconds = 0.1;
    ...
    public static void ProcessMainThreadQueue(double delta)
    {
        ...
        {
            deltaTotal -= CheckIntervalSeconds;
